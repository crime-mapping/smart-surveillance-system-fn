...
const getSeverityCardStyle = (level?: string) =>
  level === "HIGH"
    ? "bg-red-50 border-red-300 dark:bg-red-900/40"
    : level === "MEDIUM"
      ? "bg-yellow-50 border-yellow-300 dark:bg-yellow-900/40"
      : "bg-green-50 border-green-300 dark:bg-green-900/40";
